...
def main() -> None:
    ...
    for r in rows:
        ...
        if idx in GROUND_TRUTH:
            ...
            table_rows.append([
                ...
                r["plain_pred"],
                r["final_choice"],
                "Yes" if r["plain_pred"] == GROUND_TRUTH[idx] else "No"
            ])
    ...
    if y_true and y_pred:
        ...
        print("\nClassification Metrics Table:")
        header = ["Card Index", "Ground Truth", "Rule Label", "Transformer Prediction", "Final Choice", "Correct?"]
        row_format = "{:<11} {:<15} {:<15} {:<24} {:<15} {:<8}"
